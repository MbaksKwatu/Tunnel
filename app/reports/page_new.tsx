...
export default function ReportsPage() {
  ...
  const generateIC = async () => {
    ...
    try {
        ...
        const response = await axios.post(`http://localhost:8000/api/document/${selectedDocId}/report`, {}, {
  ...
  const generateCustomReport = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8000/generate-custom-report', {
