    ...
    try:
        with pdfplumber.open(file_path) as pdf:
            ...
            if text.count("(cid:") < 20:
                # Not a CID-encoded PDF — definitely not Stanbic.
                return False
        # CID garbage confirmed.  OCR page 1 at low DPI to verify the bank name.
...
def extract_stanbic_pdf(file_path: str) -> ExtractionResult:
    ...
    images = convert_from_path(file_path, dpi=_OCR_DPI)
